...
export function makeBlankQuestion(//-
    ...
    return {};//-
export function makeBlankQuestion(id: number, name: string, type: "multiple_choice_question" | "short_answer_question"): Question {//+
    return {//+
        id,//+
        name,//+
        body: "",//+
...
export function mergeQuestion(question1: Question, question2: Question): Question {//+
    return {//+
        ...question1,//+
        id: question2.id,//+
        name: question2.name,//+
